                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                        <li>
                                            ...
                                            <?php if ($data['status'] == "anggota") : ?>
                                                <a href="ubahstatus.php?id=<?= $data["id_user"]; ?>&status=<?= $data['status']; ?>" class="dropdown-item" onclick="return confirm('Jadikan admin?')">Jadikan Admin</a>
                                            <?php else : ?>
                                                <a href="ubahstatus.php?id=<?= $data["id_user"]; ?>&status=<?= $data['status']; ?>" class="dropdown-item" onclick="return confirm('Jadikan admin?')">Jadikan Anggota</a>
                                            <?php endif; ?>
                                        </li>
                                    </ul>
                                </td>
